...
var outfits = [
  {
    ...
    product: '衬衫 + 针织背心 + 百褶裙',
    platform: '淘宝校园优选',
    profit: '商家推广费进入平台激励池，优先奖励完整度高的校园内容',
  ...
  },
  {
    ...
    product: '卫衣 + 工装裤 + 运动鞋',
    platform: '天猫精选',
    profit: '商家推广费进入平台激励池，导购点击会计入互动分',
  ...
  },
  {
    ...
    platform: '京东校园馆',
    profit: '品牌合作预算进入合作激励池，按专题规则发放奖励',
  ...
  },
  {
    ...
    product: '衬衫 + 针织马甲 + 短裙',
    platform: '淘宝校园优选',
    profit: '品牌合作预算进入合作激励池，按内容质量与互动结算',
  ...
  },
  {
    ...
    platform: '京东校园馆',
    profit: '商家推广费进入平台激励池，互动与有效点击会影响结算',
...
var messages = [
  ...
  { id: 'm3', type: '系统通知', title: '商品链接审核通过', desc: '你提交的导购链接已通过审核，后续跳转会计入导购点击统计和传播效果分析。', time: '12分钟前' },
  { id: 'm4', type: '评论提醒', title: '鹿宁评论了你的发布', desc: '她回复：想看你分享更多预算 100 元以内的穿搭。', time: '28分钟前' },
  { id: 'm5', type: '激励通知', title: '本周创作激励待结算', desc: '你的内容本周预计结算 86.50 元创作激励，请留意结算记录。', time: '1小时前' }
]
